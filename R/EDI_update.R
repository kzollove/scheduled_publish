...
eml_path <- here("/Users/kylezollovenecek/Box/EDI/scheduled_publish/", "eml")
...
eml <- EML::write_eml(eml_doc, here("/Users/kylezollovenecek/Box/EDI/scheduled_publish/", "eml", paste0(new_pnum,".xml")))
